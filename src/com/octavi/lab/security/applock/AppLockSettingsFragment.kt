...
package com.octavi.lab.security.applock
...
import com.octavi.lab.fragments.OctaviDashboardFragment

@SearchIndexable
class AppLockSettingsFragment : OctaviDashboardFragment(),
    MenuItem.OnMenuItemClickListener {

    private var debugEnabled = SystemProperties.get(DEBUG_PROPERTY, null) == LEVEL_DEBUG
    private var handledClick = false

    override protected fun getPreferenceScreenResId() = R.xml.octavi_settings_app_lock
    ...
    companion object {
        ...
        @JvmField
        val SEARCH_INDEX_DATA_PROVIDER = BaseSearchIndexProvider(R.xml.octavi_settings_app_lock)
    }
}
